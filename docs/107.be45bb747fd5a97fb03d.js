...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! rxjs/operators */ 4612);
...
let LoginComponent = /*#__PURE__*/(() => {
  class LoginComponent {
    ...
    logInWithGoogle() {
      location.href = "https://accounts.google.com/o/oauth2/v2/auth?client_id=" + src_environments_environment__WEBPACK_IMPORTED_MODULE_1__.environment.GOOGLE_CLIENT_ID + "&redirect_uri=" + src_environments_environment__WEBPACK_IMPORTED_MODULE_1__.environment.FRONT_END_URL + "google-login&response_type=id_token%20token&scope=profile&nonce=abcdef";
    }
